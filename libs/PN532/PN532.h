...
public:
    ...
    */
    ...
    bool inListPassiveTarget(uint8_t *uid, uint8_t *uidLength);
    ...
    bool inDataExchange(uint8_t *send, uint8_t sendLength, uint8_t *response, uint8_t *responseLength, uint16_t timeout = 1000);
